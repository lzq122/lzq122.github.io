  ...
  */
  ...
  n3.prototype.createMenu = function() {
    ...
    if (n3.options.durationControl) { 
      ...
      durationControl.append('span').attr('class', 'menu-label').html('调节速度');
    ...
    menu.append("div").attr('class', 'menu-item').html("<a href='https://github.com/michalgm/ndtv-d3/blob/master/README.md' target='_blank'></a></div>");
